...
<head>
	...
	<meta name="description" content="JohnDoe landing page.">
	<meta name="author" content="Devcrud">
	<title>JohnDoe Landing page</title>
	<!-- font icons -->
	<link rel="stylesheet"
		href="<?php echo get_stylesheet_directory_uri(); ?>/assets/vendors/themify-icons/css/themify-icons.css">
	<!-- Bootstrap + JohnDoe main styles -->
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/css/johndoe.css">
</head>
		...
		<div class="container">
			...
			<div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav brand">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/imgs/avatar.jpg" alt=""
						class="brand-img">
					<li class="brand-txt">
